...
안녕하십니까. AI와 빅데이터 기술을 이용해 전략경영 및 AI경영을 하고 싶은 김동해입니다. 진부한 이야기일지 모르지만 저에게는 대한민국이라는 나라를 더욱 강하게 만들고 싶은 꿈이 있습니다. 
...
- 인생을 살며 달성하고 싶은 가장 큰 연구 주제.
### 시끄러운 소수 조용한 다수의 온라인 세계에서의 불균형 현상
- 온라인 및 인터넷 세계를 경영자 및 소비자 관점에서 재해석 하는 과정이 필요하다.
- 이 과정이 제대로 이루어지지 않는다면 크롤링을 통해 얻는 데이터는 불완전한 데이터이다.
- 더 나아가 온라인 세상과, 오프라인 세상에서 한 개인의 페르소나를 비교 분석 하는 연구도 기획중이다.
### 다크 패턴 억제를 통한 수익 창출 전략
- 페이크 리뷰, 페이크 보고서 등의 억제를 통한 소비자 반응 증대를 수익 증대에 활용할 수 있다.
### AI도입이 소비자들에게 미치는 영향
- AI 챗봇이 소비자들의 확증편향을 증가시킬 것이다.
- AI 요약 리뷰가 소비자들의 경향성을 증가시킬 것이다.
